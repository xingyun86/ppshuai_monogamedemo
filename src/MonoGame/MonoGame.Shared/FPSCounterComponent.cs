...
namespace MonoGame.Shared
{
	public class FPSCounterComponent : DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > TimeSpan.FromSeconds(1.0f))
            {
                elapsedTime -= TimeSpan.FromSeconds(1.0f);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(spriteFont, fps, new Vector2(1, 21), Color.Black);
            spriteBatch.DrawString(spriteFont, fps, new Vector2(0, 20), Color.White);
        }
    }
}
